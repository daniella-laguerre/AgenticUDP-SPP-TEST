...
- Bench tool source:
  [`entropyops-helper/cmd/eo-ingest-bench/main.go`](../../entropyops-helper/cmd/eo-ingest-bench/main.go)
- Bench-mode flag implementation:
  [`entropyops-v2/internal/storage/baseline_mode.go`](../../entropyops-v2/internal/storage/baseline_mode.go)
- Per-row write path (the standard-baseline storage write):
  [`entropyops-v2/internal/storage/sqlite/client.go`](../../entropyops-v2/internal/storage/sqlite/client.go)
  (search for `WriteTracesPerRow`)
- Receiver dispatch helper:
  [`entropyops-v2/internal/ingest/receiver/otlp_baseline_dispatch.go`](../../entropyops-v2/internal/ingest/receiver/otlp_baseline_dispatch.go)
- AgenticUDP coalescer + flush instrumentation:
  [`entropyops-v2/internal/ingest/receiver/agenticudp_coalescer.go`](../../entropyops-v2/internal/ingest/receiver/agenticudp_coalescer.go)
- Step-by-step operator runbook:
  [`docs/operator/INGEST_BENCH_QUICKSTART.md`](../operator/INGEST_BENCH_QUICKSTART.md)
- Plan B (third-party backend):
  [`docs/operator/THIRD_PARTY_BACKEND_BENCH_PLAN.md`](../operator/THIRD_PARTY_BACKEND_BENCH_PLAN.md)
- Handler parity work:
  [`docs/operator/HANDLER_PARITY_PLAN.md`](../operator/HANDLER_PARITY_PLAN.md)
- Raw JSON for the numbers in this post:
  [`docs/operator/bench-results/bench-{200,1000,5000}-baseline.json`](../operator/bench-results/)
